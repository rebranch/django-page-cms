...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.group_inner_index'
        db.add_column(u'pages_page', 'group_inner_index',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.group_inner_index'
        db.delete_column(u'pages_page', 'group_inner_index')
    ...
    models = {
        ...
        u'pages.page': {
            ...
            'group_inner_index': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
